...
function comparePowers(n1,n2){
    if(n1[0] > n2[0] && n1[1] > n2[1]) {return -1}
    else if(n1[0] > n2[0] && n2[1] - n1[1] < 10) {return -1}
    else if(n1[0] < n2[0] && n2[0] - n1[0] > 3000000000) {return 1}
    else if(n1[0] ** n1[1] === n2[0] ** n2[1] && n1[0] ** n1[0] != Infinity) {return 0}
    
    else if(n1[0] < n2[0] && n1[1] < n2[1]) {return 1}
    else if(n1[1] > n2[1]) {return -1}
    else if(n1[0] > n2[0] && n1[1] < n2[1] && n2[1] - n1[1] > 25) {return 1}
    else if(n1[1] < n2[1]) {return 1}
    
    else {
     const firstMember = n1[0] ** n1[1]
     const secondMember = n2[0] ** n2[1]
     return firstMember > secondMember ? -1 : firstMember === secondMember ? 0 : 1
    }
 }
