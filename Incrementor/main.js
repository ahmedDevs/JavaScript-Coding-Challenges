...
Given an input of an array of digits, return the array with each digit incremented
 by its position in the array: the first digit will be incremented by 1, the second digit by 2, etc.
...
function incrementer(nums) {
    ...
    return nums.map(e => e > 9 ? Number(e.toString().charAt(1)) : Number(e));
 }
