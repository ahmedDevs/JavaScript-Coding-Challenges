...
function sortTwisted37(arr) {
    const newArr = arr.map((e,i) => e.toString().split('').map((e,i,a) => e === '3' ? e = '7' : e === '7' ? e = '3' : e).join(''))
    return newArr.sort((a,z) => a - z).map((e,i,a) => e.split('').map((e,i,a) => e === '7' ? e = '3' : e === '3' ? e = '7' : e).join('')).map(e => Number(e))
}